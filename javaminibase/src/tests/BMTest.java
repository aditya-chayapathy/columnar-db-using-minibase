...
class BMDriver extends TestDriver implements GlobalConst {
    ...
    protected boolean test1() {
        ...
        System.out.print("  - Allocate " + numPages + " new pages\n");
        ...
        System.out.print("First pid " + firstPid.pid + "\n");
        ...
        pid = new PageId();
        lastPid = new PageId();
        System.out.print("pid " + firstPid.pid + "\n");
        System.out.print("lastpid " + pid.pid + numPages + "\n");
        ...
        for (pid.pid = firstPid.pid, lastPid.pid = pid.pid + numPages;
            ...
            if (status == OK) {
                ...
                // coincidence.
                //System.out.print("currentpid "+pid.pid+"\n");
