...
class SailorSM {
    ...
    public SailorSM(int _sid, String _sname, int _rating, double _age) {
        sid = _sid;
        sname = _sname;
        rating = _rating;
        age = _age;
...
class BoatsSM {
    ...
    public BoatsSM(int _bid, String _bname, String _color) {
        bid = _bid;
        bname = _bname;
        color = _color;
    }
...
//Define the ReservesSM schema
class ReservesSM {
    public int sid;
    public int bid;
    public String date;

    public ReservesSM(int _sid, int _bid, String _date) {
        sid = _sid;
        bid = _bid;
        date = _date;
    }
...
class JoinsDriverSM implements GlobalConst {
     ...
     * Constructor
     */
    public JoinsDriverSM() {

        //build SailorSM, BoatsSM, ReservesSM table
        sailors = new Vector();
        boats = new Vector();
        reserves = new Vector();

        sailors.addElement(new SailorSM(53, "Bob Holloway", 9, 53.6));
        sailors.addElement(new SailorSM(54, "Susan Horowitz", 1, 34.2));
        sailors.addElement(new SailorSM(57, "Yannis Ioannidis", 8, 40.2));
        sailors.addElement(new SailorSM(59, "Deborah Joseph", 10, 39.8));
        sailors.addElement(new SailorSM(61, "Landwebber", 8, 56.7));
        sailors.addElement(new SailorSM(63, "James Larus", 9, 30.3));
        sailors.addElement(new SailorSM(64, "Barton Miller", 5, 43.7));
        sailors.addElement(new SailorSM(67, "David Parter", 1, 99.9));
        sailors.addElement(new SailorSM(69, "Raghu Ramakrishnan", 9, 37.1));
        sailors.addElement(new SailorSM(71, "Guri Sohi", 10, 42.1));
        sailors.addElement(new SailorSM(73, "Prasoon Tiwari", 8, 39.2));
        sailors.addElement(new SailorSM(39, "Anne Condon", 3, 30.3));
        sailors.addElement(new SailorSM(47, "Charles Fischer", 6, 46.3));
        sailors.addElement(new SailorSM(49, "James Goodman", 4, 50.3));
        sailors.addElement(new SailorSM(50, "Mark Hill", 5, 35.2));
        sailors.addElement(new SailorSM(75, "Mary Vernon", 7, 43.1));
        sailors.addElement(new SailorSM(79, "David Wood", 3, 39.2));
        sailors.addElement(new SailorSM(84, "Mark Smucker", 9, 25.3));
        sailors.addElement(new SailorSM(87, "Martin Reames", 10, 24.1));
        sailors.addElement(new SailorSM(10, "Mike Carey", 9, 40.3));
        sailors.addElement(new SailorSM(21, "David Dewitt", 10, 47.2));
        sailors.addElement(new SailorSM(29, "Tom Reps", 7, 39.1));
        sailors.addElement(new SailorSM(31, "Jeff Naughton", 5, 35.0));
        sailors.addElement(new SailorSM(35, "Miron Livny", 7, 37.6));
        sailors.addElement(new SailorSM(37, "Marv Solomon", 10, 48.9));

        boats.addElement(new BoatsSM(1, "Onion", "white"));
        boats.addElement(new BoatsSM(2, "Buckey", "red"));
        boats.addElement(new BoatsSM(3, "Enterprise", "blue"));
        boats.addElement(new BoatsSM(4, "Voyager", "green"));
        boats.addElement(new BoatsSM(5, "Wisconsin", "red"));

        reserves.addElement(new ReservesSM(10, 1, "05/10/95"));
        reserves.addElement(new ReservesSM(21, 1, "05/11/95"));
        reserves.addElement(new ReservesSM(10, 2, "05/11/95"));
        reserves.addElement(new ReservesSM(31, 1, "05/12/95"));
        reserves.addElement(new ReservesSM(10, 3, "05/13/95"));
        reserves.addElement(new ReservesSM(69, 4, "05/12/95"));
        reserves.addElement(new ReservesSM(69, 5, "05/14/95"));
        reserves.addElement(new ReservesSM(21, 5, "05/16/95"));
        reserves.addElement(new ReservesSM(57, 2, "05/10/95"));
        reserves.addElement(new ReservesSM(35, 3, "05/15/95"));
    ...
    */
        ...
        for (int i = 0; i < numsailors; i++) {
            try {
                t.setIntFld(1, ((SailorSM) sailors.elementAt(i)).sid);
                t.setStrFld(2, ((SailorSM) sailors.elementAt(i)).sname);
                t.setIntFld(3, ((SailorSM) sailors.elementAt(i)).rating);
                t.setFloFld(4, (float) ((SailorSM) sailors.elementAt(i)).age);
            } catch (Exception e) {
        ...
        for (int i = 0; i < numboats; i++) {
            try {
                t.setIntFld(1, ((BoatsSM) boats.elementAt(i)).bid);
                t.setStrFld(2, ((BoatsSM) boats.elementAt(i)).bname);
                t.setStrFld(3, ((BoatsSM) boats.elementAt(i)).color);
            } catch (Exception e) {
        ...
        for (int i = 0; i < numreserves; i++) {
            try {
                t.setIntFld(1, ((ReservesSM) reserves.elementAt(i)).sid);
                t.setIntFld(2, ((ReservesSM) reserves.elementAt(i)).bid);
                t.setStrFld(3, ((ReservesSM) reserves.elementAt(i)).date);
...
public class SM_JoinTest {
    public static void runTests() {
        ...
        JoinsDriverSM jjoin = new JoinsDriverSM();
