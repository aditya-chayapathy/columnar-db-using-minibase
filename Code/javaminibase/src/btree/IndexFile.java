...
public abstract class IndexFile {
     ...
     * @param position  the position of the tuple with the key
     ...
     */
    abstract public void insert(final KeyClass data, final int position)
     ...
     * @throws IndexSearchException      index search failed
     */
    abstract public boolean Delete(final KeyClass data, final int position)
